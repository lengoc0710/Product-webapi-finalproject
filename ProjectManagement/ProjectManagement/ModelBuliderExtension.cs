...
using ProductsManagement.Model.FluentValidation;
using Serilog;
using System;
...
namespace ProductsManagement
{
    public static class ModelBuliderExtension
    {
        ...
        {
            var builder = services.AddIdentityCore<ApiUserSystem>(q => { q.User.RequireUniqueEmail = true; });
        ...
        public static void ConfigureValidation(this IServiceCollection services)
        {
            ...
            services.AddTransient<IValidator<CreateHangHoaDTO>, CreateHangHoaValidation>();
            services.AddTransient<IValidator<CreateLoaiDTO>, LoaiValidation>();
